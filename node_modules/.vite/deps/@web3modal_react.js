import {
  ...
  pe,
  ue
} from "./chunk-PSRHUHMY.js";
import "./chunk-NQVKPCUU.js";
import {
  require_react
...
var x = (t, e) => {
  for (var r in e || (e = {}))
    V.call(e, r) && u(t, r, e[r]);
  if (p)
    for (var r of p(e))
      k.call(e, r) && u(t, r, e[r]);
  return t;
};
function re(t) {
...
var U = (t, e) => {
  var r = {};
  for (var o in t)
    N.call(t, o) && e.indexOf(o) < 0 && (r[o] = t[o]);
  if (t != null && v)
    for (var o of v(t))
      e.indexOf(o) < 0 && Q.call(t, o) && (r[o] = t[o]);
  return r;
};
function A(t) {
  var e = t, { ethereumClient: r } = e, o = U(e, ["ethereumClient"]);
  const i = (0, import_react.useCallback)(async () => {
    ue.setThemeConfig(o), r && f.setEthereumClient(r), C.setConfig(o), await import("./dist-73M4U72N.js"), b.setIsUiLoaded(true);
  }, [r, o]);
